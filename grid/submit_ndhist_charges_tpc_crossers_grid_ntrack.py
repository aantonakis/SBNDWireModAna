...
def run_grid(inputfiles):
    ...
    os.system('cp ../grid/bin/grid_executable_ndhist_charges_tpc_crossers_ntrack.sh %s' %MasterJobDir)
    ...
    cp_script = "cp " + WIREMOD_WORKING_DIR + "/macros/NDHist/ndhist_charges_tpc_crossers_grid_ntrack.C " + MasterJobDir
...
"file://$(pwd)/grid_executable_ndhist_charges_tpc_crossers_ntrack.sh" \\
"%s" \\
