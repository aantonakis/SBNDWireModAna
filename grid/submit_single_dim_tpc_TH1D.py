...
def run_grid(inputfiles):
    ...
    OutputDir = SBNDCALIB_GRID_OUT_DIR + "/single_dim_tpc_TH1D/" + args.output + "__" + timestamp
    ...
    os.system('cp ../grid/bin/grid_executable_single_dim_tpc_TH1D.sh %s' %MasterJobDir)
    ...
    cp_script = "cp " + WIREMOD_WORKING_DIR + "/macros/LowDim/single_dim_tpc_grid_TH1D.C " + MasterJobDir
...
"file://$(pwd)/grid_executable_single_dim_tpc_TH1D.sh" \\
"%s" \\
