...
def run_grid(inputfiles):
    ...
    OutputDir = SBNDCALIB_GRID_OUT_DIR + "/ndmap_tracks_tpc/" + args.output + "__" + timestamp
    ...
    os.system('cp ../grid/bin/grid_executable_ndmap_tracks_tpc.sh %s' %MasterJobDir)
    ...
    cp_script = "cp " + WIREMOD_WORKING_DIR + "/macros/NDMaps/ndmap_tracks_tpc_grid.C " + MasterJobDir
...
"file://$(pwd)/grid_executable_ndmap_tracks_tpc.sh" \\
"%s" \\
