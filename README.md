...
- Open the script to see all available options

- Calibration Options: SCE, YZ Uniformity, E-Lifetime and Calibration Constant

- Various selection options are available

- A vector of ints is configured in this script to provide the dimensions to store
...
- The number of grid jobs is the number of merged outputs from the input file list


Example Useage\

```
$ python /grid/submit_merge_hists.py -l file_list.list -o hist_dir_name -nfile 100 -ngrid 10"
```
