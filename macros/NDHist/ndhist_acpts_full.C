...
const TString kLabels[kNdims] = { "x", "y", "z", "txz", "tyz", "width", "integral" };
const TString kTitles[kNdims] = { "x (cm)", "y (cm)", "z (cm)", 
    "ThetaXZ (deg)", "ThetaYZ (deg)", "Width", "Integral"};

// Binnning --> Go as fine as possible and coarse grain later if needed
const Int_t kNbins[kNdims] = { 460, 460, 560, 360, 360, 200, 2500};
const Double_t kXmin[kNdims] = { -230, -230, -30, -180, -180, 0, 0};
	      ...
	      unsigned short east_tpc = 0;
		      ...
		      trk_thyz = TMath::ATan(*trk_diry / *trk_dirz) * 180. / TMath::Pi();
                    ...
                    */
                    ...
                    Double_t val[kNdims]  = {
                        sp.X(), sp.Y(), sp.Z(), trk_thxz, trk_thyz, width[ip][i], integral[ip][i] 
                    };
