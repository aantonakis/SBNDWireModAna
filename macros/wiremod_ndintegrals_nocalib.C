...
const Int_t kNbins[kNdims] = { 60, 60, 70, 30, 30, 50, 500 };
const Double_t kXmin[kNdims] = { -300, -300, -100, -180, -180, 0, 0 };
const Double_t kXmax[kNdims] = { 300, 300, 600, 180, 180, 5000, 1000 };



void wiremod_ndintegrals_nocalib(const char* input_file, const char* output_file) {
